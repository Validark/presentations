function zig_mainline_parser_end() {
    document.getElementById("zig_mainline_parser").innerHTML = ``
}

function zig_mainline_parser_start() {
    document.getElementById("zig_mainline_parser").innerHTML = `//! Represents in-progress parsing, will be converted to an Ast after completion.
